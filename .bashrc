...
alias mesond='meson configure build -Dbuildtype=debug -Db_sanitize=address -Db_lundef=false'
alias mesonr='meson configure build -Dbuildtype=release -Db_sanitize=none -Db_lundef=true'
